...
<body>
  ...
  <p class="note">This document is generated from <code>spec.md</code> and <code>src/treatmentSummarySpec.ts</code>. It is a complete component-level specification for the five patient forms, expressed with the shared <code>fbXxx</code> vocabulary. Additional behaviour and field metadata are written as <code>attr:</code> bullets.</p>
