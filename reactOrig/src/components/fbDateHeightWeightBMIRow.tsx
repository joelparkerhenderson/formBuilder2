...
import { fbReadOnly as FbReadOnly } from './fbReadOnly';
    ...
    <FbGridRow cols={4}>
      ...
      <FbGridCell>
        <div title="This BMI calculation is not validated or certified for clinical use">
          <FbReadOnly label="Uncertified calculated BMI (kg/m2)" value={bmi === null ? '' : String(bmi)} preserveGridSpace labelProps={{ style: { fontSize: '1rem' } }} />
        </div>
      </FbGridCell>
    </FbGridRow>
  );
