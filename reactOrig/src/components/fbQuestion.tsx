...
export const fbSubfieldContext = React.createContext(false);
...
export const fbQuestion: React.FC<fbQuestionProps> = ({
  ...
  const inheritedSubfield = React.useContext(fbSubfieldContext);
  const labelIsSubfield = subfield || inheritedSubfield;
    ...
    >
      ...
      <label
        style={{
          ...
          fontSize: '1rem',
          fontWeight: labelIsSubfield ? 300 : 500,
          color: 'black',
          margin: 0,
          display: 'block',
          ...labelStyle
