...
export function FbcntPageSelector({
  store,
  selectedPatientUuid,
  selectedVolumeUuids,
  toggleVolume,
                    ...
                    >
                      ...
                      {items.map((volume) => (
                        ...
                        <HighlightBlock
                          key={volume.uuid}
                          level={3}
                          style={{ ...styles.volumeRow, gridTemplateColumns: 'minmax(10rem, 1fr) 6.5rem minmax(16rem, 2fr) 2rem', paddingLeft: '4.8rem' }}
                        >
                          ...
                          <span style={styles.volumeMeta}><FbcntLocationDisplay store={store} volume={volume} withIcon /></span>
