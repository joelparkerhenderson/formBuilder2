      ...
      try {
        ...
        if (formUuid) {
          ...
          if (!cancelled) {
            ...
            setFinalChecked(formData.form_status === 'final');
    ...
    <>
      {isReadOnlyView ? (
        <div className="bg-white h-screen max-h-screen overflow-hidden flex flex-col" style={{ height: '100vh', fontFamily: "'Roboto', sans-serif", fontWeight: 300, lineHeight: 1.1 }}>
          <FbRoVHeader title="Treatment summary" patient={patient} formStatus={formStatus} superseded={superseded} highlySensitive={highlySensitive} />
