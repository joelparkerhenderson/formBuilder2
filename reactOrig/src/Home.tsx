...
export default function Home() {
  ...
  const implantsHref = underFormBuilder2 ? '/formBuilder2/implants.html' : '/implants.html';
  const outpatientOutcomesHref = underFormBuilder2 ? '/formBuilder2/outpatientOutcomes.html' : '/outpatientOutcomes.html';
  ...
  const systemTiles: HomeTile[] = [
    ...
    { kind: 'href', label: 'Implant registry', href: implantsHref, background: 'linear-gradient(135deg, #1b6ec2, #c5e1a5)', color: 'black' },
    { kind: 'href', label: 'Outpatient outcomes', href: outpatientOutcomesHref, background: 'linear-gradient(135deg, #8cd2e7, #1b6ec2)' },
