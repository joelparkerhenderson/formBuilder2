  ...
  const handleFieldChange = (fieldName: string, value: any, coded?: boolean, nadexId?: string) => {
    setFormState((prev) => {
      ...
      if (coded !== undefined) {
        ...
        updated[`${fieldName}_text`] = value;
        updated[`${fieldName}_NADEXId`] = nadexId || '';
      }
      return updated;
    });
    setFormChanged(true);
                    ...
                    <FbGridRow cols={4}>
                      ...
                      <FbQuestion label="Senior responsible clinician" required={true}>
                        <MSISelector
                          ...
                          onChange={(value, coded, nadexId) =>
                            handleFieldChange("seniorClinician", value, coded, nadexId)
                          }
                          required
                      ...
                      <FbGridCell span={2}>
                        <FbQuestion label="Listed by">
                          <MSISelector
                            ...
                            onChange={(value, coded, nadexId) =>
                              handleFieldChange("listedBy", value, coded, nadexId)
                            }
                          />
                        </FbQuestion>
                      </FbGridCell>
                            ...
                            >
                              {opt.value === "named_clinician" && (
                                <MSISelector
                                  ...
                                  onChange={(value, coded, nadexId) =>
                                    handleFieldChange("namedClinicianName", value, coded, nadexId)
                                  }
                                />
                              )}
                            </FbRadio>
