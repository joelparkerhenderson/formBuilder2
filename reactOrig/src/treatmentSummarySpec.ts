import { specialityValuesForHealthBoard } from "./data/clinicalDestinations";
...
const cntSpecialityOptions = specialityValuesForHealthBoard("")
  .map((value) => specialities.find((option) => option.value === value))
  .filter((option): option is DesignerOption => Boolean(option));
  ...
  components: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          label: "Grid row 2",
          children: [
            { id: "cell19", type: "fbGridCell", label: "Grid cell 5", colSpan: 1, children: [{ id: "field19", type: "fbDropdown", label: "Speciality", required: true, options: cntSpecialityOptions }] },
