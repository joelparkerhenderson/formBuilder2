  ...
  <FbLayout sections={sectionsConfig} formState={formState} bind:activeSection isReadOnlyView={true}>
    ...
    <div style="padding: 0.4rem;">
      <FbSection id="section-from" title="From">
        <FbGridRow cols={4}>
          <FbRoVField label="Organisation" value={formState.organisation} lookupTable={organisationLabels} />
          <FbRoVField label="Speciality" value={formState.speciality} lookupTable={specialityLabels} />
          <FbRoVField label="Hospital" value={formState.hospital} lookupTable={hospitalLabels} />
          <FbRoVField label="Senior responsible clinician" value={formState.seniorClinician} coded={formState.seniorClinician_coded} />
        </FbGridRow>
      </FbSection>
      <FbSection id="section-listing" title="Listing and priority">
        <FbGridRow cols={4}>
          <FbRoVField label="Date listed" value={formState.dateListed} />
          <FbRoVField label="Listed by" value={formState.listedBy} coded={formState.listedBy_coded} />
          <FbRoVField label="Urgency" value={formState.urgency} lookupTable={Object.fromEntries(urgencyOptions.map((item) => [item.value, item.label]))} />
          <FbRoVField label="Operating surgeon" value={formState.operatingSurgeon} lookupTable={Object.fromEntries(operatingSurgeonOptions.map((item) => [item.value, item.label]))} />
        </FbGridRow>
      </FbSection>
      ...
      <FbSection id="section-other" title="Other">
        <FbRoVField label="Any other information" value={formState.otherInfo} />
      </FbSection>
    </div>
  ...
  <FbLayout sections={sectionsConfig} formState={formState} bind:activeSection onFormActivity={handleFormActivity}>
    ...
    <FbSection id="section-from" title="From">
      <FbGridRow cols={4}>
        ...
        <FbMSISelector id="seniorClinician" name="seniorClinician" label="Senior responsible clinician" required value={formState.seniorClinician || ''} coded={formState.seniorClinician_coded} change={(value, coded) => setField('seniorClinician', value, coded)} />
      </FbGridRow>
    </FbSection>
