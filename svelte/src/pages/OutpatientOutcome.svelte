...
{#snippet readonlyContent()}
  <div class="oo-content">
    <div class="oo-group fb-question-container">
      ...
      <div class="oo-grid">
        <FbRoVField label="Organisation" value={formState.organisation} />
        <FbRoVField label="Speciality" value={formState.speciality} />
        <FbRoVField label="Site" value={formState.site} />
        <FbRoVField label="Senior responsible clinician" value={formState.seniorClinician} />
        <FbRoVField label="Clinic name" value={formState.clinicName} />
        <FbRoVField label="Date" tooltip={dateTooltip} value={formState.date} />
        <FbRoVField label="Time" tooltip={timeTooltip} value={formState.time} />
      </div>
    </div>
    <FbRoVField label="Attendance" value={formState.attendedOption === 'attended' ? 'Attended' : formState.attendedOption === 'unableToAttend' ? 'Unable to attend' : formState.attendedOption === 'didNotAttend' ? 'Did not attend' : ''} />
    {#if formState.attendedOption === 'attended'}
      <FbRoVField label="Urgent suspected cancer" tooltip={uscTooltip} value={formState.usc === 'yes' ? 'Yes' : formState.usc === 'no' ? 'No' : ''} />
      <FbRoVField label="Working diagnosis" value={formState.workingDiagnosis} coded={formState.workingDiagnosis_coded} />
      <div class="oo-group fb-question-container">
    ...
    {/if}
    <FbRoVField label="Notes" value={formState.notes} />
  </div>
{/snippet}
