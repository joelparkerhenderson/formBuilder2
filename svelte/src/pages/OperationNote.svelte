<script lang="ts">
  import SpecDrivenForm from '../components/SpecDrivenForm.svelte';
  import { operationNoteSpec } from '../lib/specDrivenFormSpecs';
...
<SpecDrivenForm spec={operationNoteSpec} {patientUuid} {formUuid} {openInRoV} {inline} {onClose} />
