...
{:else if isReadOnlyView}
  <FbLayout sections={sectionsConfig} formState={formState} bind:activeSection isReadOnlyView={true}>
    <svelte:fragment slot="header"><FbHeader title="Treatment summary" {patient} formStatus={effectiveFormStatus} /></svelte:fragment>
    <div style="padding: 0.4rem;">
      <FbSection id="section1" title="Details">
        <FbGridRow cols={3}>
          <FbReadOnly label="Has the patient received a copy of this document?" value={displayValue('group5')} />
          <FbReadOnly label="Has the patient seen this document?" value={displayValue('field9')} />
          <span></span>
        </FbGridRow>
        <FbGridRow cols={3}>
          <FbReadOnly label="Speciality" value={displayValue('field19')} />
          <FbReadOnly label="Senior responsible clinician" value={formState.field21} coded={formState.field21_coded} />
          <FbReadOnly label="Clinical nurse specialist" value={formState.field23} coded={formState.field23_coded} />
        </FbGridRow>
        <FbGridRow cols={3}>
          <FbReadOnly label="Daytime 'phone number" value={formState.field25} />
          <FbReadOnly label="Out of hours 'phone number" value={formState.field27} />
          <FbReadOnly label="Carer or emergency contact" value={formState.field30} />
        </FbGridRow>
      </FbSection>

      <FbSection id="section2" title="Diagnosis">
        <FbGridRow cols={3}>
          <FbReadOnly label="Diagnosis" value={formState.field32} coded={formState.field32_coded} />
          <FbReadOnly label="Staging" value={formState.field34} />
          <span></span>
        </FbGridRow>
        <FbReadOnly label="Diagnosis comments" value={formState.field36} />
      </FbSection>

      <FbSection id="section3" title="Treatment">
        <FbReadOnly label="Treatment" value={formState.field37} />
        <FbReadOnly label="Treatment aim" value={displayValue('field38')} />
        <FbReadOnly label="Treatment aim comments" value={formState.field39} />
        <FbReadOnly label="Other important information (effects of the disease, side effects of treatment)" value={formState.field40} />
      </FbSection>

      <FbSection id="section4" title="Prognosis">
        <FbGridRow cols={3}>
          <FbGridCell span={2}><FbReadOnly label="Prognosis" value={displayValue('field42')} /></FbGridCell>
          <FbReadOnly label="Prognosis certainty" value={displayValue('field44')} />
        </FbGridRow>
        <FbReadOnly label="Alert symptoms that require referral back to specialist team" value={formState.field46} />
      </FbSection>

      <FbSection id="section47" title="Referrals">
        <FbReadOnly label="Primary care actions requested" value={formState.field49} />
        <FbReadOnly label="Onward referrals made" value={formState.field50} />
      </FbSection>

      <FbSection id="section48" title="Follow-up">
        <FbGridRow cols={3}>
          <FbReadOnly label="Follow-up plan" value={displayValue('field52')} />
          <FbGridCell span={2}><FbReadOnly label="Comments" value={formState.field54} /></FbGridCell>
        </FbGridRow>
      </FbSection>
    </div>
  ...
  <FbLayout sections={sectionsConfig} formState={formState} bind:activeSection onFormActivity={handleFormActivity}>
    ...
    <FbSection id="section1" title="Details">
      ...
      <FbGridRow cols={3}>
        ...
        <FbMSISelector id="field21" name="field21" label="Senior responsible clinician" required value={formState.field21 || ''} coded={formState.field21_coded} change={(value, coded, nadexId) => setField('field21', value, coded, nadexId)} />
        <FbMSISelector id="field23" name="field23" label="Clinical nurse specialist" required value={formState.field23 || ''} coded={formState.field23_coded} change={(value, coded, nadexId) => setField('field23', value, coded, nadexId)} />
      </FbGridRow>
      <FbGridRow cols={3}>
