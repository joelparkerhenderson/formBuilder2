...
{#if inlineActiveForm}
  <div class="patient-record-inline-form">
    {#if inlineActiveForm.formType === 'waiting_list_card'}
      <WaitingListCard {patientUuid} formUuid={inlineActiveForm.formUuid || ''} openInRoV={!!inlineActiveForm.openInRoV} readOnlyBackOnly inline onClose={closeInlineForm} />
    {:else if inlineActiveForm.formType === 'operation_note'}
      <OperationNote {patientUuid} formUuid={inlineActiveForm.formUuid || ''} openInRoV={!!inlineActiveForm.openInRoV} readOnlyBackOnly inline onClose={closeInlineForm} />
    {:else if inlineActiveForm.formType === 'outpatient_outcome'}
      <OutpatientOutcome {patientUuid} formUuid={inlineActiveForm.formUuid || ''} appointmentUuid={inlineActiveForm.appointmentUuid || ''} openInRoV={!!inlineActiveForm.openInRoV} readOnlyBackOnly inline onClose={closeInlineForm} />
    {:else if inlineActiveForm.formType === 'treatment_summary'}
      <TreatmentSummary {patientUuid} formUuid={inlineActiveForm.formUuid || ''} openInRoV={!!inlineActiveForm.openInRoV} readOnlyBackOnly inline onClose={closeInlineForm} />
    {:else if inlineActiveForm.formType === 'cardiology_test_request'}
      <CardiologyTestRequest {patientUuid} formUuid={inlineActiveForm.formUuid || ''} openInRoV={!!inlineActiveForm.openInRoV} readOnlyBackOnly inline onClose={closeInlineForm} />
    {/if}
  </div>
{:else}
