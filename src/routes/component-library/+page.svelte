<script lang="ts">
  ...
  import FbBoxedAlert from '$lib/components/fb/fbBoxedAlert.svelte';
  ...
  import FbSubqForOption from '$lib/components/fb/fbSubqForOption.svelte';
  ...
  <main id="component-library-main" aria-label={readOnlyView ? 'Component library read-only view' : 'Component library edit view'}>
    {#if !readOnlyView}
      <FbSection id="component-library-questions" title="Question components">
        ...
        <FbGridRow cols={3}>
          <FbGridCell><FbHBSelector label="Health board selector" bind:value={healthBoard} required options={healthBoards} /></FbGridCell>
        ...
        <FbGridRow cols={3}>
          ...
          <FbGridCell><FbNumberInputWithUnits label="Number input with units" bind:value={numberWithUnits} units="mg" /></FbGridCell>
          <FbGridCell>
            <FbBloodPressure
    ...
    {:else}
      <FbSection id="component-library-rov-questions" title="Question components">
        <FbGridRow cols={3}>
          <FbGridCell><FbReadOnly label="Text input" value={text} preserveGridSpace /></FbGridCell>
          <FbGridCell><FbReadOnly label="Time" value={time} preserveGridSpace /></FbGridCell>
          <FbGridCell><FbReadOnly label="Dropdown" value={dropdown === 'option-one' ? 'Option one' : 'Option two'} preserveGridSpace /></FbGridCell>
        </FbGridRow>
        <FbGridRow cols={3}>
          <FbGridCell><FbReadOnly label="Number input" value={number} preserveGridSpace /></FbGridCell>
          <FbGridCell><FbReadOnly label="Number input with units" value={`${numberWithUnits} mg`} preserveGridSpace /></FbGridCell>
          <FbGridCell><FbReadOnly label="Blood pressure" value={`${bloodPressure.systolic}/${bloodPressure.diastolic} mmHg`} preserveGridSpace /></FbGridCell>
        </FbGridRow>
        <FbGridRow cols={3}>
          <FbGridCell span={2}><FbReadOnly label="Text area" value={textarea} preserveGridSpace /></FbGridCell>
          <FbGridCell>
            <FbReadOnly label="Radio group" value={radio === 'yes' ? 'Yes' : 'No'} preserveGridSpace />
            <FbReadOnly label="Checkbox group" value={check ? 'Checkbox option' : ''} preserveGridSpace />
          </FbGridCell>
        </FbGridRow>
      </FbSection>
      <FbSection id="component-library-rov-dates-selectors" title="Dates and selectors">
        <FbGridRow cols={3}>
          <FbGridCell><FbReadOnly label="Partial date" value={partialDate} preserveGridSpace /></FbGridCell>
          <FbGridCell><FbReadOnly label="Exact date" value={exactDate} preserveGridSpace /></FbGridCell>
          <FbGridCell><div aria-hidden="true"></div></FbGridCell>
        </FbGridRow>
        <FbGridRow cols={3}>
          <FbGridCell span={2}><FbReadOnly label="Staff selector" value={msi} coded={msiCoded} preserveGridSpace /></FbGridCell>
          <FbGridCell><div aria-hidden="true"></div></FbGridCell>
        </FbGridRow>
        <FbGridRow cols={3}>
          <FbGridCell span={2}><FbReadOnly label="SNOMED CT diagnosis" value={diagnosis} coded={diagnosisCoded} preserveGridSpace /></FbGridCell>
          <FbGridCell><div aria-hidden="true"></div></FbGridCell>
        </FbGridRow>
        <FbGridRow cols={3}>
          <FbGridCell span={2}><FbReadOnly label="SNOMED CT procedure" value={procedure} coded={procedureCoded} preserveGridSpace /></FbGridCell>
          <FbGridCell><div aria-hidden="true"></div></FbGridCell>
        </FbGridRow>
      </FbSection>
