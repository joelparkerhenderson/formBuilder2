...
interface AddFormMenuProps {
  onSelectFormType: (formType: 'outpatient_outcome' | 'waiting_list' | 'operation_note' | 'treatment_summary' | 'cardiology_test_request') => void;
  onCancel: () => void;
  ...
  return (
    <>
      ...
      >
        ...
        <button
          type="button"
          onClick={() => onSelectFormType('cardiology_test_request')}
          style={{
            width: '100%',
            textAlign: 'left',
            padding: '0.5rem',
